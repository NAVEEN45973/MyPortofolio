          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
              <Row className=" align-items-start p-2 my-details rounded">
                Hi there! I am <strong>&nbsp;SRIKAKULAPU NAVEEN</strong>
                <br />A passionate programmer, born and brought up in India. I
                am a Full Stack Web Developer with React.js, Php, Node.js, and
                MySQL as my tech stack.
                <br />
                I am currently pursuing B.Tech Computer Science in Lovely
                Professional University.
                <br />
                My goal is always driven towards providing amazing experience
                with the best level of quality and service to the clients.
                <br />
                ...
                <Col className="d-flex justify-content-center flex-wrap">
                  ...
                  <div>
                    <a
                      href="https://drive.google.com/file/d/1PRCY7Z4CseWkA58mwrhmiq026UCJFKEC/view"
                      target="_blank"
